          ...
          {ticketNumber ? (
            ...
            <>
              ...
              <form onSubmit={submit} style={{ display: "grid", gap: 18 }}>
                ...
                <label style={{ ...labelStyle, display: "flex", gridTemplateColumns: "none", alignItems: "flex-start", gap: 10, fontWeight: 650 }}><input type="checkbox" checked={cancelRenewal} onChange={(event) => setCancelRenewal(event.target.checked)} style={{ marginTop: 3 }} /><span>Ask Scriboo support to cancel future renewal as part of this request. This form records your request; it does not change Stripe instantly. For immediate self-service cancellation, use Manage billing in your Scriboo account. Paid access normally remains until the end of the already-paid period unless the law or an approved refund requires otherwise.</span></label>
